...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path+'/bsTest' + '/resources/css/ext-all' + suffix + '-debug.css"/>');
    }
    document.write('<script type="text/javascript" src="' + path+'/bsTest' + '/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    ...
    if (neptune) {
        ...
        if (repoDevMode &&  window.ActiveXObject) {
            ...
            document.write('<script type="text/javascript" src="packages/ext-theme-neptune/build/ext-theme-neptune.js"></script>');
        }
    }
